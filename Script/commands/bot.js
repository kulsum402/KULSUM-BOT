...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "tor ball") || (event.body.toLowerCase() == "bal")) {
     return api.sendMessage("~ আস্তাক-ফিরুল্লা তবা তবা কি বলে  🤖", threadID);
   };

  if ((event.body.toLowerCase() == "Tasfi") || (event.body.toLowerCase() == "Tasfiya Apu") || (event.body.toLowerCase() == "@Tasfiya Sultana") || (event.body.toLowerCase() == "Admin Tasfiya")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[Admin: Tasfiya Sultana https://www.facebook.com/profile.php?id=100000654976375\***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage Tasfiya Sultana আমি একজন কৃত্রিম বুদ্ধিমত্তা বট। আমাকে আপনি বিভিন্ন উপায়ে ব্যাবহার করতে পারেন।", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage(@Tasfiya Sultan ", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami Tasfi") || (event.body.toLowerCase() == "cup sala ami Bolod") || (event.body.toLowerCase() == "madari")) {
